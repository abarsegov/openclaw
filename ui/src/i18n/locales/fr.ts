...
export const fr: TranslationMap = {
  ...
  configForm: {
    ...
    invalidNumber: "Saisissez une valeur comprise dans la plage et le pas autorisés.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppNotReady:
        "llama.cpp n'a pas produit de modèle local utilisable. Vérifiez le résultat de la configuration, puis réessayez.",
    },
    manual: {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "L'application web fonctionne déjà. Ajoutez un canal seulement si vous souhaitez envoyer des messages à OpenClaw depuis un autre service.",
    ...
    composer: {
      ...
      menu: {
        ...
        toolAccess: {
          ...
          summary: "{enabled} sur {total} outils activés",
          summaryOne: "{enabled} sur {total} outil activé",
        },
