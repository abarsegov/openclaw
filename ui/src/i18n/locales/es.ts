...
export const es: TranslationMap = {
  ...
  configForm: {
    ...
    invalidString: "Introduce un valor que cumpla las restricciones de esta configuración.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppNotReady:
        "llama.cpp no generó un modelo local utilizable. Revisa el resultado de la configuración y vuelve a intentarlo.",
    },
    manual: {
      ...
      accessValueFor: "Clave o token de API de {provider}",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "La app web ya funciona. Agrega un canal solo si quieres enviar mensajes a OpenClaw desde otro servicio.",
  ...
  mcpServers: {
    ...
    sessionChanged: "La sesión activa cambió antes de poder habilitarse.",
