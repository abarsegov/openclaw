...
export const nl: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppNotReady:
        "llama.cpp heeft geen bruikbaar lokaal model geproduceerd. Bekijk het setupresultaat en probeer het opnieuw.",
    },
    manual: {
      title: "Verbinding maken met een API-sleutel of token",
      provider: "Provider",
      selectProvider: "Selecteer een provider",
      selectProviderHint: "Kies waar deze credential vandaan komt",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "De web-app werkt al. Voeg alleen een kanaal toe als je OpenClaw vanuit een andere dienst wilt berichten.",
  ...
  mcpServers: {
    ...
    sessionUnavailable: "De actieve sessie is niet beschikbaar; vernieuw en probeer opnieuw.",
  ...
  labsPage: {
    ...
    loopDetection: {
      title: "Tool-loop-detectie",
      description:
        "Schakel voortschrijdende-geschiedenisbeveiligingen in die waarschuwen voor of herhaalde tool-aanroepen blokkeren wanneer een agent geen voortgang meer boekt.",
    },
    localModelLean: {
