...
export const pl: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Żądanie aktualizacji mogło zostać przyjęte, ale Gateway nie zgłosił ostatecznego wyniku po ponownym połączeniu. Uruchom `openclaw update status` przed ponowieniem próby.",
    failureReasons: {
  ...
  configForm: {
    ...
    invalidString: "Wprowadź wartość spełniającą ograniczenia tego ustawienia.",
    invalidNumber: "Wprowadź wartość w dozwolonym zakresie i kroku.",
    draftRejected: "Nie udało się zapisać tego ustawienia. Twoja wersja robocza wciąż tu jest.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppNotReady:
        "llama.cpp nie utworzył użytecznego lokalnego modelu. Sprawdź wynik konfiguracji, a następnie spróbuj ponownie.",
    },
    manual: {
      ...
      verifyHint:
        "OpenClaw weryfikuje prawdziwą odpowiedź modelu przed oznaczeniem połączenia jako gotowego.",
      required: "Wybierz dostawcę i wprowadź klucz API lub token.",
    },
    success: {
      title: "Twoja sztuczna inteligencja jest gotowa",
      body: "OpenClaw otrzymał prawdziwą odpowiedź od {modelRef}. Możesz teraz rozpocząć czat.",
  ...
  dreaming: {
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "defragmentacja zakamarków pamięci…",
  ...
  chat: {
    ...
    composer: {
      ...
      menu: {
        ...
        addMcpServerDescription: "Skonfiguruj serwer i wybierz, gdzie jest włączony.",
