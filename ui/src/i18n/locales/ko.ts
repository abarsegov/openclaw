...
export const ko: TranslationMap = {
  ...
  configForm: {
    ...
    draftRejected: "이 설정을 저장할 수 없습니다. 임시 저장본은 그대로 남아 있습니다.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppNotReady:
        "llama.cpp가 사용 가능한 로컬 모델을 생성하지 못했습니다. 설정 결과를 확인한 후 다시 시도하세요.",
    },
    manual: {
  ...
  labsPage: {
    ...
    loopDetection: {
      title: "도구 루프 감지",
      description:
        "에이전트가 진행을 멈출 때 반복되는 도구 호출을 경고하거나 차단하는 롤링 히스토리 가드를 활성화합니다.",
    },
    localModelLean: {
      title: "로컬 모델용 경량 도구",
      description:
  ...
  dreaming: {
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "추억의 길 조각 모으는 중…",
