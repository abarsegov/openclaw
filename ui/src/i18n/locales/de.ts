...
export const de: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Die Update-Anfrage wurde möglicherweise akzeptiert, aber der Gateway hat nach der erneuten Verbindung kein endgültiges Ergebnis gemeldet. Führen Sie `openclaw update status` aus, bevor Sie es erneut versuchen.",
    failureReasons: {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppNotReady:
        "llama.cpp hat kein verwendbares lokales Modell erzeugt. Überprüfen Sie das Einrichtungsergebnis und versuchen Sie es erneut.",
    },
    manual: {
      title: "Mit einem API-Schlüssel oder Token verbinden",
      provider: "Anbieter",
      selectProvider: "Anbieter auswählen",
      selectProviderHint: "Wählen Sie aus, woher dieser Zugang stammt",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Aktiviere Verlaufsschutz, der wiederholte Tool-Aufrufe warnt oder blockiert, wenn ein Agent keine Fortschritte mehr macht.",
    },
    localModelLean: {
