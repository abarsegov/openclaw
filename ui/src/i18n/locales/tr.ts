...
export const tr: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppNotReady:
        "llama.cpp kullanılabilir bir yerel model üretmedi. Kurulum sonucunu inceleyin, ardından yeniden deneyin.",
    },
    manual: {
      ...
      accessValueFor: "{provider} API anahtarı veya token'ı",
    ...
    success: {
      ...
      body: "OpenClaw, {modelRef} kaynağından gerçek bir yanıt aldı. Şimdi sohbete başlayabilirsiniz.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupAction: "Bir kanal kurun",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Sunucu genel olarak devre dışı bırakılmış şekilde kaydedildi, ancak bu oturum için etkinleştirilemedi: {error}",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Bir aracı ilerleme kaydetmeyi durdurduğunda tekrarlanan araç çağrılarını uyaran veya engelleyen kayan geçmiş korumalarını etkinleştirin.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "bellek şeridi birleştiriliyor…",
